...
#define MQTT_TOPIC "topic_num_RGB"      // Топик для приёма изображения от брокера.
#define MQTT_TOPIC2 "topicCallback"     // Топик для обратной связи. 
...
void on_message(struct mosquitto* mosq, void* obj, const struct mosquitto_message* message)
{
       ...
       // char* msg2 = "2";
        //message_publish(mosq,msg2);
        
  
}
void message_publish(struct mosquitto* mosq, const char* msg) {
    int ret = mosquitto_publish(mosq, NULL, MQTT_TOPIC2, strlen(msg), msg, 0, false);
